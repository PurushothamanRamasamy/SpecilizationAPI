...
namespace SpecilizationAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<SpecializationContext>(item => item.UseSqlServer(Configuration.GetConnectionString("conStr")));
            services.AddTransient<ISpecializationRepo, SpecializationRepo>();
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "SpecilizationAPI", Version = "v1" });
            });
        }
